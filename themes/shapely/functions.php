...
function shapely_scripts() {
	...
	// Add Google Fonts
	wp_enqueue_style( 'shapely-fonts', '//fonts.googleapis.com/css?family=Raleway:100,300,400,500,600,700%7COpen+Sans:400,500,600%7CJosefin+Slab:n,b,i,bi%7cPlay:n,b' );
	// wp_enqueue_style( 'funsfonts'. '//fonts.googleapis.com/css?family=Arvo:n,b,i,bi|Asap:n,b,i,bi|Chivo:n,i|Droid+Serif:n,b,i,bi|Josefin+Slab:n,b,i,bi&amp;subset=Latin,Latin-ext');
	// wp_enqueue_style( 'opensans'. '//fonts.googleapis.com/css?family=Open+Sans:n,b,i,bi|Oswald:n,b|Play:n,b&amp;subset=Cyrillic,Cyrillic-ext,Greek,Greek-ext,Latin,Latin-ext,Vietnamese');
	...
	wp_enqueue_script( 'cpsharp-scripts', get_template_directory_uri() . '/js/cpsharp.js', array( 'jquery' ), '1', true );
}
